...
/**
 * <p>Java class for AvailabilityLossTypeEnum-1.1.1.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AvailabilityLossTypeEnum-1.1.1">
...
public enum AvailabilityLossTypeEnum111 {
    ...
    AvailabilityLossTypeEnum111(String v) {
        value = v;
    }
    ...
    public static AvailabilityLossTypeEnum111 fromValue(String v) {
        for (AvailabilityLossTypeEnum111 c: AvailabilityLossTypeEnum111 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
