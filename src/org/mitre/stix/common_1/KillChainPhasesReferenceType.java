...
public class KillChainPhasesReferenceType {
    ...
    protected List<KillChainPhaseReferenceType> killChainPhases;
     ...
     * 
     */
    public List<KillChainPhaseReferenceType> getKillChainPhases() {
        if (killChainPhases == null) {
            killChainPhases = new ArrayList<KillChainPhaseReferenceType>();
        }
