    ...
    extends GenericRelationshipListType
{
    ...
    protected List<RelatedTTPType> relatedTTPs;
     ...
     * This is why there is not a <CODE>set</CODE> method for the relatedTTPs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRelatedTTPs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RelatedTTPType> getRelatedTTPs() {
        if (relatedTTPs == null) {
            relatedTTPs = new ArrayList<RelatedTTPType>();
        }
