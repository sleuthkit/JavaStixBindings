...
public class SymLinksListType {
    ...
    protected List<StringObjectPropertyType> symLinks;
     ...
     * This is why there is not a <CODE>set</CODE> method for the symLinks property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSymLinks().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<StringObjectPropertyType> getSymLinks() {
        if (symLinks == null) {
            symLinks = new ArrayList<StringObjectPropertyType>();
        }
